...
import com.cg.ba.service.BankService;
import com.cg.ba.service.BankServiceImpl;
import com.cg.ba.util.DBUtil;
...
static BankService ser=null;
	...
	private static void fundTransfer() throws BankException {
		...
		for(int p=0;p<fetchData.size();p++)
		{
			...
			if(cusSetBal.getAccNum()==AccNum)
			{
				...
				{
					throw new BankException(" you do not have sufficient funds ");
				}
				else
				{
					...
					System.out.println("*****************************************************************************************************************");
					System.out.println(" Funds has been transferred to "+tranferDetails.getCusDetails().getCusName());
					System.out.println("*****************************************************************************************************************");
				    break;
				}
	...
	private static void showBalance() throws BankException {
		...
		System.out.println("*****************************************************************************************************************");
		System.out.println("Hi "+" "+bal.getCusDetails().getCusName()+" Your Balance for "+bal.getAccNum()+" Account Number is Rs. "+bal.getCusBal());
		System.out.println("*****************************************************************************************************************");
	}
	private static void createAccount() throws BankException {
		...
		BankDetails bank=new BankDetails(accNum,cusBal,cd);
		  ...
		  System.out.println("*****************************************************************************************************************");
		  System.out.println("Hello "+cd.getCusName()+" Your account has been succesfully created  "+accNumber);
		  System.out.println("*****************************************************************************************************************");
	}
